...
/// @summary Abstract away Windows 32-bit calling conventions and visibility.
    ...
    #define  LLOPENGL_IMPORT    __attribute__((dllimport))
    #define  LLOPENGL_EXPORT    __attribute__((dllexport))
    #else
    ...
    #if __GNUC__ >= 4
    #define  LLOPENGL_IMPORT    __attribute__((visibility("default")))
    #define  LLOPENGL_EXPORT    __attribute__((visibility("default")))
    #endif
#endif
